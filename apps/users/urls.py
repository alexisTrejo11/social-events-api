...
urlpatterns = [
    ...
    # ========================================================================
    path("auth/oauth/google/", GoogleLoginView.as_view(), name="google-login"),
    path("auth/oauth/github/", GitHubLoginView.as_view(), name="github-login"),
    path(
        "auth/oauth/accounts/",
        ListSocialAccountsView.as_view(),
    ...
    path(
        "users/me/preferences/", UserPreferencesView.as_view(), name="user-preferences"
    ),
    path(
        "users/<str:username>/",
    ...
    path(
        "users/<str:username>/follow/", UnfollowUserView.as_view(), name="unfollow-user"
    ),
